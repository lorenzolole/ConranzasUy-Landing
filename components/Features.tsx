    ...
    <section id="features" className="py-24 bg-neutral-950 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6">
        <motion.div
          ...
          className="mb-16"
        >
          <h2 className="text-4xl md:text-5xl font-bold mb-6">El Sistema</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          {featureList.map((feature, idx) => (
            <motion.div
              ...
              className="group p-8 border border-white/5 rounded-2xl bg-black/50 hover:bg-white/5 hover:border-white/10 transition-all duration-300"
            >
      ...
      <div className="absolute top-1/2 right-0 -translate-y-1/2 translate-x-1/2 w-96 h-96 bg-white/5 blur-[120px] rounded-full pointer-events-none" />
    </section>
  );
};
